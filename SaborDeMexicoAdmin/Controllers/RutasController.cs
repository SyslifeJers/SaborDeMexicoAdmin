...
namespace SaborDeMexicoAdmin.Controllers
{
    public class RutasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Lat,Lon,Google,Direccion")] Ruta ruta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Lat,Lon,Google,Direccion")] Ruta ruta)
        {
            if (id != ruta.Id)
            {
                return NotFound();

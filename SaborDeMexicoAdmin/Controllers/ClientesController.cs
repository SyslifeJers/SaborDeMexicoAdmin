...
namespace SaborDeMexicoAdmin.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Correo,Telefono,Contrasena,Activo,Modificado,Token")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Correo,Telefono,Contrasena,Activo,Modificado,Token")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
